...
#         to a word document.                                                  #
#==============================================================================#
external_figure = "Source/illustrations/figure_methods.pdf"                                                           #  
print(paste0("External Figure: ", external_figure))                                  #
#==============================================================================#
...
pacman::p_load(cowplot, magick, pdftools)
...
# Load external image into ggplot object for panels

empty_plot <- ggplot() + theme_void()

p.methods <- ggdraw() + draw_image(image_read_pdf(external_figure)) +
  draw_plot(empty_plot)

#==============================================================================#
# Step 1B: Optional add multiple plots to save file to create panels                                                          #
#==============================================================================#

resave(p.methods, file=panel_data_file)
...
# =============================================================================#
caption_Search_Term <- "\\*Figure 1A"  # edit. use '\' to escape special chars
